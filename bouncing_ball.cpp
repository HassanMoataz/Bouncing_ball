...
#define midx 31
#define midy 12
#define spacex  ((width - 1) / 2) - (space_len - 1) / 2 - 1
#define spacey length - 4
#define ball 'O'

const int  border = 2;
const int width = 60 + 2 * border + 1;
const int swidth = 30;
const int length = 25 + 1;
const int slab_len = 12;
const int space_len = 15;
const int left_bond = 3;
const int right_bond = width - 2;
const int up_bond = 2;
const int down_bond = length - 4;
...
char map[length][width + swidth + 1] = {
	"                                                                                               ",
	" ##############################################################################################",
	" ##############################################################################################",
	" ##                                                            ##                            ##",
...
char start_map[length][width + swidth + 1] = {
	"                                                                                               ",
	" ##############################################################################################",
	" ##############################################################################################",
	" ##                                                                                          ##",
...
char mid_map[length][width + swidth + 1] = {
	"                                                                                               ",
	" ##############################################################################################",
	" ##############################################################################################",
	" ##                                                                                          ##",
...
char player_one_win_map[length][width + swidth + 1] = {
	"                                                                                               ",
	" ##############################################################################################",
	" ##############################################################################################",
	" ##                                                                                          ##",
...
char player_two_win_map[length][width + swidth + 1] = {
	"                                                                                               ",
	" ##############################################################################################",
	" ##############################################################################################",
	" ##                                                                                          ##",
...
void generate_stage_2(int diff)
{
	...
	for (int i = 1; i < diff + 1; i++)
	{
		for (int j = 0; j < 5; j++)
		{
			slab_fill(3 + j * slab_len, up_bond + i, slabs[(i - 1) * 5 + j]);
		}
	}
	//show and wait
	for (int display = 0; display < length; display++)
